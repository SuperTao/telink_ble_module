...
//replace macro
#define USB_Descriptor_Header_t 		USB_Descriptor_Hdr_t
#define USB_StdDescriptor_Header_t	 	USB_StdDescriptor_Hdr_t
...
//replace macro
#define USB_Descriptor_Configuration_Header_t 		USB_Descriptor_Configuration_Hdr_t
#define USB_StdDescriptor_Configuration_Header_t 	USB_StdDescriptor_Configuration_Hdr_t
