...
static const USB_Descriptor_HIDReport_Datatype_t usbaud_report_desc[] = {
	HID_RPT_USAGE_PAGE(8, 0x0c), /* Consumer Page */
	HID_RPT_USAGE(8, 0x01)		, /* Consumer Controls */
    HID_RPT_COLLECTION(8, 0x01)		, /* Application */

    HID_RPT_REPORT_ID(8, 0x01)		, /*Report ID*/

    HID_RPT_LOGICAL_MINIMUM(8, 0x00)		,
    HID_RPT_LOGICAL_MAXIMUM(8, 0x01),

    HID_RPT_USAGE(8, 0xcd),  /* Play/Pause (toggle) */
	HID_RPT_USAGE(8, 0xb5)		, /* Next Track */
	HID_RPT_USAGE(8, 0xb6)		, /* Previous Track */
	HID_RPT_USAGE(8, 0xb7)		, /* Stop */

    HID_RPT_REPORT_SIZE(8, 0x01)		,
    HID_RPT_REPORT_COUNT(8, 0x04),
    HID_RPT_INPUT(8, HID_IOF_VARIABLE),
    HID_RPT_LOGICAL_MINIMUM(8, 0x00),
    HID_RPT_LOGICAL_MAXIMUM(8, 0x01),
    
    HID_RPT_USAGE(8, 0xb0),  /* Play */
    HID_RPT_USAGE(8, 0xb1)		, /* Pause */
    HID_RPT_USAGE(8, 0xb3)		, /* Fast Forward */
    HID_RPT_USAGE(8, 0xb4)		, /* Rewind */

    HID_RPT_REPORT_SIZE(8, 0x01)		,
    HID_RPT_REPORT_COUNT(8, 0x04),
    HID_RPT_INPUT(8, HID_IOF_NO_PREFERRED_STATE | HID_IOF_VARIABLE),
    HID_RPT_LOGICAL_MINIMUM(8, 0x00),
    HID_RPT_LOGICAL_MAXIMUM(8, 0x01),
    HID_RPT_USAGE(8, 0xe9),
    HID_RPT_USAGE(8, 0xea),
    HID_RPT_USAGE(8, 0xe2),
    HID_RPT_REPORT_SIZE(8, 0x01),
    HID_RPT_REPORT_COUNT(8, 0x03),
    HID_RPT_INPUT(8, HID_IOF_NO_PREFERRED_STATE | HID_IOF_VARIABLE),
    HID_RPT_REPORT_SIZE(8, 0x05),
    HID_RPT_REPORT_COUNT(8, 0x01),
    HID_RPT_INPUT(8, HID_IOF_CONSTANT),
    HID_RPT_END_COLLECTION(0),
	HID_RPT_USAGE_PAGE(16, 0xffa0),
    HID_RPT_USAGE(8, 0x01),
    HID_RPT_COLLECTION(8, 0x01),  /* Application */

    HID_RPT_REPORT_ID(8, 0x02)		, /*Report ID*/

    HID_RPT_USAGE(8, 0x01)		,
    HID_RPT_LOGICAL_MINIMUM(8, 0x00),
	HID_RPT_LOGICAL_MAXIMUM(16, 0x00ff),
    HID_RPT_REPORT_SIZE(8, 0x08),
    HID_RPT_REPORT_COUNT(8, 0x02),
    HID_RPT_OUTPUT(8, HID_IOF_DATA),
    HID_RPT_USAGE(8, 0x02),  /* mouse? */

    HID_RPT_REPORT_SIZE(8, 0x08)		,
    HID_RPT_REPORT_COUNT(8, 0x02),
    HID_RPT_INPUT(8, HID_IOF_DATA),
    HID_RPT_END_COLLECTION(0),  };
